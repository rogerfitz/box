...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'users_profile', (
            ...
            ('addr1', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('addr2', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
