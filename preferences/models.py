...
class Preferences(models.Model):
	...
	alcohol = models.CharField(verbose_name="Favorite Alcohol", max_length=3, blank=True, choices=(('G', 'Gin'), ('W', 'Whiskey'), ('R', 'Rum'), ('V', 'Vodka'), ('T', 'Tequila'),('N', "Don't Drink"),))
	...
	clip_on = models.BooleanField(verbose_name="Does a clip-on bowtie upset you?", default=1, choices=((0, 'Yes'), (1, 'No')))
