...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BoxFeedback'
        db.create_table(u'boxes_boxfeedback', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('feedback', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal(u'boxes', ['BoxFeedback'])

        # Adding M2M table for field user on 'BoxFeedback'
        m2m_table_name = db.shorten_name(u'boxes_boxfeedback_user')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('boxfeedback', models.ForeignKey(orm[u'boxes.boxfeedback'], null=False)),
            ('user', models.ForeignKey(orm[u'users.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['boxfeedback_id', 'user_id'])
        ...
        db.create_table(u'boxes_box', (
            ...
            ('date_delivered', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        ...
        # Adding M2M table for field feedback on 'Box'
        m2m_table_name = db.shorten_name(u'boxes_box_feedback')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('box', models.ForeignKey(orm[u'boxes.box'], null=False)),
            ('boxfeedback', models.ForeignKey(orm[u'boxes.boxfeedback'], null=False))
        ))
        db.create_unique(m2m_table_name, ['box_id', 'boxfeedback_id'])


    def backwards(self, orm):
        # Deleting model 'BoxFeedback'
        db.delete_table(u'boxes_boxfeedback')

        # Removing M2M table for field user on 'BoxFeedback'
        db.delete_table(db.shorten_name(u'boxes_boxfeedback_user'))
        ...
        # Removing M2M table for field feedback on 'Box'
        db.delete_table(db.shorten_name(u'boxes_box_feedback'))
