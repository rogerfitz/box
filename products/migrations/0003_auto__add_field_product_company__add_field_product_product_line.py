...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'products_product', 'company')

        # Deleting field 'Product.product_line'
        db.delete_column(u'products_product', 'product_line')
    ...
    models = {
        ...
        u'products.product': {
            ...
            'product_line': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
