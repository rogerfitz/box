...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.product_line'
        db.alter_column(u'products_product', 'product_line', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Product.company'
        db.alter_column(u'products_product', 'company', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Product.product_line'
        db.alter_column(u'products_product', 'product_line', self.gf('django.db.models.fields.CharField')(default='Null', max_length=200))

        # Changing field 'Product.company'
        db.alter_column(u'products_product', 'company', self.gf('django.db.models.fields.CharField')(default='Null', max_length=200))
    ...
    models = {
        ...
        u'products.product': {
            ...
            'company': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '200', 'null': 'True', 'blank': 'True'}),
            ...
            'product_line': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '200', 'null': 'True', 'blank': 'True'}),
